 ...
 */
export function setWindowsEnvVar(name: string, value: string): boolean {
  if (!isNativeWindows()) {
 ...
 */
export function patchPowerShellProfile(name: string, value: string): boolean {
  try {
 ...
 */
export function patchUnixProfile(name: string, value: string): boolean {
 ...
 */
export function persistEnvVar(name: string, value: string): { success: boolean; profilePath: string } {
  if (isNativeWindows()) {
